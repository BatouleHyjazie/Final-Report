...
plot_model(osmiaglmm, type = "eff", show.intercept = TRUE, show.data = Osmia, show.legend = TRUE, colors = "lightblue")
plot_model(osmiaglmm, type = "slope", show.p = TRUE, vline = "lightblue", show.intercept = TRUE, p.style = "numeric", colors = "blue", axis.labels = "Site Type Estimates")
plot_model(osmiaglmm, type = "resid", show.intercept = TRUE, show.data = TRUE, show.legend = TRUE, colors = "Set2")
plot_model(osmiaglmm, type = "diag", show.intercept = TRUE, show.data = TRUE, show.legend = TRUE, colors = "Set2")
```

The estimate of orchard type is non-significant (p = )
```{r 3.2.1 Frequentist Results Tables}
