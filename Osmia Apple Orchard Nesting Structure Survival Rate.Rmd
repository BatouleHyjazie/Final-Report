...
```{r 2.2 Statistical Methods Normality Q-Q Plot, fig.cap="\\label{fig:figs}Q-Q Plot of *Osmia* spp. survival ratio"}

qqPlot(Osmia$surv.ratio, xlab="Normal Quantiles", ylab="Osmia spp. Survival Ratio")
```

```{r 2.2 Statistical Methods Normality Histogram, fig.cap="\\label{fig:figs}Histogram of *Osmia* spp. survival ratio"}
...
```{r 3.2.1.1 Key Assumptions Wald Chi-Square Test GLMM vs GLM, echo = TRUE}
...
```{r 3.2.1.1 Key Assumptions Wald Chi-Square Test GLMM vs GLMM Nested, echo = TRUE}
...
```{r 3.2.1.1 Key Assumptions Osmia Overdispersion Tests, echo = TRUE}
...
r 3.2.2 Bayesian Results Inference Plot
osmiabayesfinal %>%
  emmeans( cbind(No.surv.osmia, No.death) ~ s.type, data = Osmia) %>%
